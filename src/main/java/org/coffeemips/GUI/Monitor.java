...
public class Monitor {
    ...
    public Monitor(HashMap<String, String> mem){
        ...
        for (int i = startAddress; i < endAddress; i++) {
            mem.put(org.coffeemips.memory.AddressAllocator.parse8DigitHex(i), "0");
        }
    }
    ...
    public String toString(){
        String output="";
        Memory.put(org.coffeemips.memory.AddressAllocator.parse8DigitHex(753664),"A");
        Memory.put(org.coffeemips.memory.AddressAllocator.parse8DigitHex(753666),"L");
        Memory.put(org.coffeemips.memory.AddressAllocator.parse8DigitHex(753668),"I");
        for (int i = startAddress; i < endAddress; i=i+2) {
            String Ch = Memory.get(org.coffeemips.memory.AddressAllocator.parse8DigitHex(i));
